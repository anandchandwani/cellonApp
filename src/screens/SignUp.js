...
export default class SignUp extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            loginConfirmPasswordLabelColor: colors.mainAccentColor,
            loginFullNameLabelColor: colors.mainAccentColor,
            ...
            loginFullNameBorderColor: "rgba(0,0,0,0.3)",
            loginConfirmPasswordBorderColor: "rgba(0,0,0,0.3)",
            activeFullNameLabelColor: "rgba(0,0,0,0.3)",
            activeConfirmPasswordLabelColor: "rgba(0,0,0,0.3)",
            isClient: true
        };
    }
    ...
    checkValidation = () => {
        alert(
            "you entered:" + this.state.loginFullName + " " + this.state.loginUsername + " " + this.state.loginPassword + " " + this.state.loginConfirmPassword
        );
    };
    render() {
        return (
            ...
            >
                <ScrollView contentContainerStyle={{ backgroundColor: "transparent" }}>
                    <View style={{ paddingVertical: 0, }}>
                        ...
                        <View style={{ height: WINDOWSIZE.height / 4, marginVertical: 0, justifyContent: "space-evenly", alignItems: "center", backgroundColor: "transparent" }}>
                            <View>
                                <Text style={styles.screenHeader}>Sign up how</Text>
                            </View>
                        ...
                        <View style={{ height: WINDOWSIZE.height / 3, width: "100%", marginVertical: 0, justifyContent: "space-evenly", backgroundColor: "transparent" }}>
                            <View style={{ marginVertical: 0 }}>
                                <LoginInputView
                                    ...
                                    onFocus={() => {
                                        this.setState({ loginFullNameBorderColor: colors.mainAccentDarkColor, activeFullNameLabelColor: this.state.loginFullName != null ? "rgba(0,0,0,0.3)" : colors.mainAccentColor })
                                    }}
                                    onBlur={() => {
                                        this.setState({ loginFullNameBorderColor: "rgba(0,0,0,0.3)", activeFullNameLabelColor: this.state.loginFullName == null ? "rgba(0,0,0,0.3)" : colors.mainAccentColor })
                                    }}
                                    showEye={false}
                                />
                            </View>
                            ...
                            <View>
                                <LoginInputView
                                    ...
                                    placeholderTextColor={this.state.activeConfirmPasswordLabelColor}
                                    activeLabelColor={colors.mainAccentDarkColor}
                                    ...
                                    showEye={true}
                                    onFocus={() => {
                                        this.setState({ loginConfirmPasswordBorderColor: colors.mainAccentDarkColor, activeConfirmPasswordLabelColor: this.state.loginConfirmPassword != null ? "rgba(0,0,0,0.3)" : colors.mainAccentColor })
                                    }}
                                    onBlur={() => {
                                        this.setState({ loginConfirmPasswordBorderColor: "rgba(0,0,0,0.3)", activeConfirmPasswordLabelColor: this.state.loginConfirmPassword == null ? "rgba(0,0,0,0.3)" : colors.mainAccentColor })
                                    }}
                                />
                            </View>
                        </View>
                        <View style={{ marginLeft: WINDOWSIZE.width * 0.08, height: 20, width: "100%", marginVertical: 10, justifyContent: "flex-start", backgroundColor: "transparent", flexDirection: "row" }}>
                            <Image style={{ height: 18, width: 18, }} source={require("../assets/images/checkBox.png")} />
                            <Text style={{ color: colors.mainAccentDarkColor, marginLeft: 10, fontFamily: fonts.sfproMedium }}>Confirm</Text>
                            <Text style={{ color: colors.mainAccentColor, marginLeft: 5, textDecorationLine: "underline", fontFamily: fonts.sfproMedium }}>Terms and Service</Text>
                        </View>
                        <View style={{ height: WINDOWSIZE.height / 5, marginVertical: 0, justifyContent: "space-evenly", alignItems: "center", backgroundColor: "transparent" }}>
                            ...
                            <View style={{ flexDirection: "row", alignSelf: "center" }}>
                                <Text style={{ fontWeight: 'bold', fontFamily: fonts.sfproMedium }}>Have an </Text>
                                <Text
