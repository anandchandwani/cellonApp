    ...
    return (
      <View style={{ flex: 1,margin:15 }}>
        <View style={{ flex: 1, alignItems:"center", marginHorizontal: 30, marginTop:"35%"}}>
          ...
          <Text style={{fontFamily:fonts.sfproDisplayBold, fontSize:30, color:colors.mainAccentDarkColor, marginVertical: 30}}>Successful!</Text>
          <Text style={{fontFamily:fonts.sfproRegular, fontSize:17, color:colors.mainAccentDarkColor, textAlign:"center"}}>
            {'Your payment of R340 was successfully sent to '}
            <Text style={{color:colors.mainAccentColor}}>Nelle Phillips</Text>
          </Text>
        </View>
        <BigButton 
          onPress={() => {
